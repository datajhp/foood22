...
image_urls3 = [
    ...
    {"url": "https://raw.githubusercontent.com/datajhp/foood22/main/K03.jpg", "desc": "기분 개 좋은 름름"},
...
if escape_delta.total_seconds() > 0:
    ...
    minutes = remainder // 60
    escape_msg = f"🚀 준형 탈출까지 Count Down: {days}일 {hours}시간 {minutes}분 ⏳ Let's go LA"
else:
...
with col3:
    ...
    st.markdown(
     ...
     <div style="width: 650px; height: 700px; overflow: hidden;">
         <iframe src="{url3}" width="800" height="1360" 
...
for c in comment_res.data:
    ...
    <div style='
        ...
        background-color:#2c2c2a;
            order-radius:6px;
    '>
        <p style='margin-bottom:5px; color:#f1f1f1; font-size:15px;'>{c['content']}</p>
